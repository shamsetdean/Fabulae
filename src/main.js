...
// 3. Démarrage Alpine (scan le DOM et active les directives)
window.Alpine = Alpine
try { Alpine.start() }
catch (e) { showFatalError('Erreur Alpine.start', e.message, e.stack); throw e }

// 4. Init asynchrone du store (charge la session, déclenche les rendus)
...
// 5. Suppression du splash screen une fois Alpine prêt
// On attend 2 frames pour s'assurer que le premier rendu est terminé
